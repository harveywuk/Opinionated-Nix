...
- **Branch**: `quattro` @ `f0020448` — **released as `v4.0.0`** (the tag sits on this commit). `dev`/`master` are still the 3.8.x line; keep syncing against `quattro`.
- **Port baseline**: `quattro` @ **`f0020448` (v4.0.0)**, synced August 15 2026 (326 commits from `4d93ad58`). Highlights:
...
git rev-list --count f0020448..origin/quattro   # delta since last port baseline
```
